...
urlpatterns = [
	...
	url(r'^laporan/artikel/diminati\.html$', views.LaporanArtikelDiminati.as_view(), name='laporan_artikel_diminati'),
	url(r'^laporan/trafik/brand\.html$', views.LaporanTrafikBrand.as_view(), name='laporan_trafik_brand'),
]